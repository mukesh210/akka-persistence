...
class UserRegistrationSerializer extends Serializer {
  ...
  override def toBinary(o: AnyRef): Array[Byte] = o match {
    ...
    case _ => throw new IllegalArgumentException("Only user registration event supported in this serialization")
  }
...
object CustomSerialization extends App {
  ...
  /**
    ...
    *
    * So, Serializer sits between UserRegistrationActor and Journal
    */
...
//  for(i <- 1 to 10) {
//    userRegistrationActor ! RegisterUser(s"user_$i@gmail.com", s"User $i")
//  }
}
